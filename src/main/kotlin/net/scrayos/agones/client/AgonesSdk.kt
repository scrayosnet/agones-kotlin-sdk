 ...
 * API should be used instead. A single instance of the SDK should be reused across all requests.
 *
 * Agones divides its interfaces into three different channels to signal their usage and maturity. This also allows for
 * active changes or complete removal of those interfaces in the case of issues, or if they discover that a solution
 * does not really fit into the Agones system. The available channels are:
 *
 ...
 * * **Alpha**: The endpoints have been tested only superficially or rarely, and production use is not recommended. They
 ...
 *
 * The endpoint signatures of the SDK were slightly adjusted to unify their naming scheme and to better fit into the
 * Kotlin/Java ecosystem. Generally speaking, no hidden logic is embedded into the calls and the value is therefore
...
interface AgonesSdk : AutoCloseable {
     ...
     * will be populated and published. Before calling this method, the initialization of this instance must be fully
     * completed.
     *
     ...
     *
     * This method should be called only once and the emitting of pings in the [Flow] should happen in some thread
     * related to the general game loop of this instance. If it is called in an independent thread, the health pings
     ...
     * `GameServerAllocation`s. It is preferred, that instances are assigned through `GameServerAllocation`s. However,
     ...
     * instance. It also makes the intent more clear, as this means that the instance has not just randomly crashed.
     *
    ...
    /**
     * Gets a new, immutable Snapshot of the [GameServer] resource of this instance. The data includes, among meta
     ...
     * method can be called any number of times without changing its behavior. It is guaranteed that after this call,
     * all open connections and allocated resources will be closed or released. Although not all implementations have
     * such resources, the method should still always be called (for example, within a Try-With_Resources block or a
     * use method) to cleanly terminate resource usage.
     *
     ...
     * [AutoCloseable] is, that it is not permitted to trigger any exceptions within this method.
     */
    override fun close()

    /**
     * Returns the encapsulated [Beta-Channel][Beta] of the [Agones SDK][AgonesSdk]. This sub channel allows the use of
     * the less tested and isolated interfaces within the [Agones SDK][AgonesSdk]. The retrieval of the channel does not
     ...
     * of the less tested and isolated interfaces within the [Agones SDK][AgonesSdk]. The retrieval of the channel does
     * not trigger any communication with the SDK. The interfaces of the [Alpha-Channel][Alpha] were not yet extensively
    ...
    interface Beta {
        ...
        /**
         * Retrieves the current count of the counter with the supplied [name]. The return value is guaranteed to match
         * the value set within the SDK, even if the value was not yet synchronized with the Kubernetes resource. If no
         * counter with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose count should be queried.
         *
         * @return The current count of the counter with the supplied [name]. This is guaranteed to be between `0` and
         * the capacity of this counter.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betagetcountercountkey">Agones Documentation</a>
         */
        suspend fun counterCount(name: String): Long

        /**
         * Sets a new count for the counter with the supplied [name]. If no counter with this [name] exists or the
         * [value] is not in the interval `[0, capacity]`, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose count should be modified.
         * @param value The new count that should be applied to the desired counter.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betasetcountercountkey-amount">Agones Documentation</a>
         */
        suspend fun counterCount(name: String, value: Long)

        /**
         * Increases the current count for the counter with the supplied [name]. If no counter with this [name] exists
         * or this operation would increase the corresponding counter above the current capacity, an appropriate
         ...
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose count should be incremented.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betaincrementcounterkey-amount">Agones Documentation</a>
         */
        suspend fun incrementCounter(name: String)

        /**
         * Decreases the current count for the counter with the supplied [name]. If no counter with this [name] exists
         * or this operation would decrease the corresponding counter below `0` (would get negative), an appropriate
         * exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose count should be decremented.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betadecrementcounterkey-amount">Agones Documentation</a>
         */
        suspend fun decrementCounter(name: String)

        /**
         * Retrieves the current capacity of the counter with the supplied [name]. The return value is guaranteed to
         * match the value set within the SDK, even if the value was not yet synchronized with the Kubernetes resource.
         * If no counter with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose capacity should be queried.
         *
         * @return The current capacity of the counter with the supplied [name]. This is guaranteed to be between `0`
         * and the capacity of this counter.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betagetcountercapacitykey">Agones Documentation</a>
         */
        suspend fun counterCapacity(name: String): Long

        /**
         * Sets a new capacity for the counter with the supplied [name]. If no counter with this [name] exists or the
         * [capacity] is not in the interval `[0, Long.MAX_VALUE]`, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's counter whose capacity should be modified.
         * @param capacity The new capacity that should be applied to the desired counter.
         *
         * @throws NullPointerException If `null` is supplied as the counter identifier and therefore no counter can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betasetcountercapacitykey-amount">Agones Documentation</a>
         */
        suspend fun counterCapacity(name: String, capacity: Long)

        /**
         * Retrieves the current size of the list with the supplied [name]. The return value is guaranteed to match
         * the value set within the SDK, even if the value was not yet synchronized with the Kubernetes resource. If no
         * list with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list whose size should be queried.
         *
         * @return The current size of the list with the supplied [name]. This is guaranteed to be between `0` and
         * the capacity of this list.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betagetlistlengthkey">Agones Documentation</a>
         */
        suspend fun listSize(name: String): Int

        /**
         * Retrieves the current entries of the list with the supplied [name]. The return value is guaranteed to match
         * the value set within the SDK, even if the value was not yet synchronized with the Kubernetes resource. If no
         * list with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         ...
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list whose entries should be queried.
         *
         * @return The current entries of the list with the supplied [name]. This list is guaranteed to have between `0`
         * and the capacity of this list entries.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betagetlistvalueskey">Agones Documentation</a>
         */
        suspend fun listValues(name: String): List<String>

        /**
         * Checks whether the specified [value] is within the list with the supplied [name]. The return value is
         * guaranteed to match the value set within the SDK, even if the value was not yet synchronized with the
         * Kubernetes resource. If no list with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list whose entries should be checked.
         *
         * @return Whether the specified [value] is within the list with the supplied [name].
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it or if the [value] is `null`.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betalistcontainskey-value">Agones Documentation</a>
         */
        suspend fun listContains(name: String, value: String): Boolean

        /**
         * Adds the supplied [value] to the list with the supplied [name]. If no list with this [name] exists, the entry
         * already exists in the list, or this operation would grow the corresponding list above the current
         * capacity, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list which should receive the new entry.
         * @param value The new value that should be added to the specified list.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it or if the [value] is `null`.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betaappendlistvaluekey-value">Agones Documentation</a>
         */
        suspend fun addListValue(name: String, value: String)

        /**
         * Removes the supplied [value] from the list with the supplied [name]. If no list with this [name] exists or
         * the specified entry does not exist, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list for which the existing entry should be removed.
         * @param value The existing value that should be removed from the specified list.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it or if the [value] is `null`.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betaappendlistvaluekey-value">Agones Documentation</a>
         */
        suspend fun removeListValue(name: String, value: String)

        /**
         * Retrieves the current capacity of the list with the supplied [name]. The return value is guaranteed to
         * match the value set within the SDK, even if the value was not yet synchronized with the Kubernetes resource.
         * If no list with this [name] exists, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list whose capacity should be queried.
         *
         * @return The current capacity of the list with the supplied [name]. This is guaranteed to be between `0`
         * and the capacity of this list.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betagetlistcapacitykey">Agones Documentation</a>
         */
        suspend fun listCapacity(name: String): Long

        /**
         * Sets a new capacity for the list with the supplied [name]. If no list with this [name] exists or the
         * [capacity] is not in the interval `[0, 1000]`, an appropriate exception will be thrown.
         *
         * The [Counts and Lists](https://github.com/googleforgames/agones/pull/2946) API will eventually supersede the
         * specific player tracking APIs of the [AgonesSdk], as these cover a broader use-case and offer similar
         * interfaces for tracking. Therefore, this method should be preferred.
         *
         * @param name The unique identifier of this instance's list whose capacity should be modified.
         * @param capacity The new capacity that should be applied to the desired list.
         *
         * @throws NullPointerException If `null` is supplied as the list identifier and therefore no list can be
         * derived from it.
         *
         * @see <a href="https://agones.dev/site/docs/guides/client-sdks/#betasetlistcapacitykey-amount">Agones Documentation</a>
         */
        suspend fun listCapacity(name: String, capacity: Long)
    }
    ...
    interface Alpha {
         ...
         * to the player list because of this reason, an internal exception will be thrown and no result will be
        ...
        /**
         * Retrieves the current number of players that are connected to this instance simultaneously. The return value
         ...
         * offer similar interfaces for tracking.
         *
         * @return The current number of players that are connected to this instance simultaneously.
         *
        ...
        /**
         * Retrieves the current capacity for the number of players that can be connected to this instance
         ...
         * offer similar interfaces for tracking.
         *
         * @return The current capacity for the number of players that can be connected to this instance simultaneously.
        ...
        /**
         * Sets a new capacity for the number of players that can be connected to this instance simultaneously. The
         ...
         * offer similar interfaces for tracking.
         *
         * @param capacity The new capacity for the number of simultaneously connected players for this instance. The
